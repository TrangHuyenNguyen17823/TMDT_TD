<%@ Page Title="" Language="C#" MasterPageFile="~/ClientPageMaster.Master" AutoEventWireup="true" CodeBehind="PhuKien.aspx.cs" Inherits="Ecommerce_Client.PhuKien" %>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center products-container">
                <% 
                    Ecommerce_Client.PhuKienDataUtils dataUtilsProduct = new Ecommerce_Client.PhuKienDataUtils();
                    List<Ecommerce_Client.Models.Product> products = dataUtilsProduct.GetProducts_phukien();
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <h5 class="product-name">${product.name}</h5>
                                                    <span class="product-price">$${product.price}</span>
                                                    <p class="stock-info" style="color:darkgray">
                                                                                                        <p class="stock-info" style="color:darkgray">${product.stock}</p>
                                                </div>
                                            </div>
                                            <div class="add-to-cart">
