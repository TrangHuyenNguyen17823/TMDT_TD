...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            let currentPage = 1;
            let totalPages = 10; // Thay thế với tổng số trang thực tế
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response.d, function (index, product) {
                            ...
                            productsHtml += '        <div class="product-stock">' + (product.stock > 0 ? "Còn lại: "+product.stock+" sản phẩm" : 'Out of Stock') + '</div>';
                        ...
                        updatePagination(currentPage, totalPages); // Cập nhật phân trang sau khi load dữ liệu
                    },
                    error: function () {
                        alert("Error loading products."); // Thông báo lỗi khi không thể load dữ liệu
                    }
                });
            }
