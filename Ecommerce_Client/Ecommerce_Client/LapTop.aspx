<%@ Page Title="" Language="C#" MasterPageFile="~/ClientPageMaster.Master" AutoEventWireup="true" CodeBehind="LapTop.aspx.cs" Inherits="Ecommerce_Client.LapTop" %>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center products-container">
                <% 
                    Ecommerce_Client.LaptopDataUtils dataUtilsProduct = new Ecommerce_Client.LaptopDataUtils();
                    List<Ecommerce_Client.Models.Product> products = dataUtilsProduct.GetProducts_laptop();
